...
export const metadata: Metadata = {
  title: "Rooms & Suites",
  description: "Discover our collection of luxurious rooms and suites at The Aurelian, each designed to offer an exceptional experience of comfort and elegance.",
}
...
export default function RoomsPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative flex items-center justify-center bg-foreground py-20 lg:py-28">
